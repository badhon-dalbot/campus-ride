...
import { CreditCard, Smartphone, Wallet, Plus, Trash2, Edit3, Shield, Lock, CheckCircle, ArrowLeft, Calendar, DollarSign, Star, Phone, Globe, QrCode, MapPin, Clock, User, Car, Download, Upload } from 'lucide-react';
...
export default function RidePaymentPage() {
  ...
  const handlePayment = () => {
    ...
    if (selectedMethod?.type === 'cash') {
      alert(`Cash payment of ৳${totalAmount} confirmed! Please pay the driver directly.`);
      return;
    }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Ride Payment</h1>
              <p className="text-gray-600">Pay your driver securely via SSL Commerz</p>
            </div>
          </div>

          {/* Tabs */}
          <div style={{backgroundColor: '#D7E5E5'}} className="rounded-xl border border-gray-300 shadow-sm mb-8">
            <div className="flex">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                return (
