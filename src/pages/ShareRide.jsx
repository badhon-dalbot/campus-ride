            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                ...
                <p className="text-sm text-gray-700 mb-6">
                  Fill in the basic details of your journey to find passengers.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-base text-gray-800 font-medium">
                      Be clear about your departure time and meeting point.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Info
                    ...
                    />
                    <p className="text-base text-gray-800 font-medium">
                      Set a fair price that covers your gas and vehicle costs.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Info
                    ...
                    />
                    <p className="text-base text-gray-800 font-medium">
                      Provide accurate vehicle information to help passengers
                      identify your car.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    />
                    <p className="text-base text-gray-800 font-medium">
                      Only accept passengers with verified university profile
                      details.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    />
                    <p className="text-base text-gray-800 font-medium">
                      Make pickup/drop-offs in public, well-lit areas.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <AlertCircle
                    ...
                    />
                    <p className="text-base text-gray-800 font-medium">
                      Trust your instinct and cancel if you feel uncomfortable.
                    </p>
                  </div>
                </div>
              </div>
