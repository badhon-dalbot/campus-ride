...
import { Edit3, GraduationCap, Mail, Phone, Shield } from "lucide-react";
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={
                preferences.musicAllowed ? { backgroundColor: "#17252A" } : {}
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={
                preferences.quietRides ? { backgroundColor: "#17252A" } : {}
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={
                preferences.friendlyChat ? { backgroundColor: "#17252A" } : {}
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={
                preferences.flexibleTiming ? { backgroundColor: "#17252A" } : {}
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={
                preferences.earlyPickup ? { backgroundColor: "#17252A" } : {}
              }
            >
