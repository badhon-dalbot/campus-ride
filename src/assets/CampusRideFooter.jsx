      ...
      <div className="grid grid-cols-3 gap-8 p-4 border-t border-gray-700">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><a href="#" className="hover:text-teal-400">Our offerings</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><a href="#" className="hover:text-teal-400">Share your Ride</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><a href="#" className="hover:text-teal-400">Reserve</a></li>
            <li><a href="#" className="hover:text-teal-400">Airports</a></li>
            <li><a href="#" className="hover:text-teal-400">Cities</a></li>
            <li><a href="#" className="hover:text-teal-400">Universities</a></li>
            <li><a href="#" className="hover:text-teal-400">Colleges</a></li>
          </ul>
        </div>
      </div>
